...
<div class="white-box w-years">
	<h3 class="titulo_bienvenida" style="float: left;margin-top: 0"> Bienvenido, {{ Auth::user()->fullName() }} </h3>
...
<div class="row">
	<div class="col-lg-4 col-sm-6 col-xs-12">
	    <div class="white-box analytics-info">
	        <h3 class="box-title">Total Estudiantes</h3>
...
<div class="row">
	<div class="col-md-6 col-lg-6 col-sm-12">
	    <div class="white-box">
	        <h3 class="box-title">Estudiantes Inscritos</h3>
